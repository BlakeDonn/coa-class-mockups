...
| Five-class research pilot | Main repo | **LANDED** on `work/quest-hint-prototype` (`69b6e98`, 2026-08-08): 106 claims, 22 picker targets, all gates green, Sol-high review closed. Every target carries five picker dimensions: enjoy_avoid_fit · rhythm_payoff · role_range · shared_chassis · spec_hook |
| Sixteen-class research run | Main repo, worktree `coa-picker-16class`, branch `work/2026-08-09-coa-picker-16class` | **In final audit** (measured 2026-08-10): all 21 class files present, 386 claims, 91 picker targets, 85 unblocked. Not yet landed — treat as read-only WIP |
